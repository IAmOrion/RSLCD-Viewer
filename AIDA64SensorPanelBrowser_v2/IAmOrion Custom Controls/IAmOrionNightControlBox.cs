...
{
    #region IAmOrionNightControlBox

    public class IAmOrionNightControlBox : Control
    {
        #region Fields
        ...
        public IAmOrionNightControlBox()
        {
