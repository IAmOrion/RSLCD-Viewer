...
namespace AIDA64SensorPanelBrowser_v2.IAmOrion_Custom_Controls
{
    #region IAmOrionControlBox

    public class IAmOrionControlBox : Control
    {
        ...
        private bool minEnabled = true;
        private bool maxEnabled = true;

        //Properties
        [Category("IAmOrion ControlBox")]
        public bool MinimisedEnabled
        {
            get
            {
                return minEnabled;
